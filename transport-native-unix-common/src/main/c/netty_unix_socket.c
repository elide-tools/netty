...
#include "netty_jni_static.h"
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, shutdown, netty_unix_socket_shutdown)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, bind, netty_unix_socket_bind)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, listen, netty_unix_socket_listen)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, connect, netty_unix_socket_connect)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, finishConnect, netty_unix_socket_finishConnect)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, disconnect, netty_unix_socket_disconnect)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, accept, netty_unix_socket_accept)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, remoteAddress, netty_unix_socket_remoteAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, localAddress, netty_unix_socket_localAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, remoteDomainSocketAddress, netty_unix_socket_remoteDomainSocketAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, localDomainSocketAddress, netty_unix_socket_localDomainSocketAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, newSocketDgramFd, netty_unix_socket_newSocketDgramFd)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, newSocketStreamFd, netty_unix_socket_newSocketStreamFd)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, newSocketDomainFd, netty_unix_socket_newSocketDomainFd)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, newSocketDomainDgramFd, netty_unix_socket_newSocketDomainDgramFd)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendTo, netty_unix_socket_sendTo)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendToAddress, netty_unix_socket_sendToAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendToAddresses, netty_unix_socket_sendToAddresses)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendToDomainSocket, netty_unix_socket_sendToDomainSocket)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendToAddressDomainSocket, netty_unix_socket_sendToAddressDomainSocket)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendToAddressesDomainSocket, netty_unix_socket_sendToAddressesDomainSocket)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, send, netty_unix_socket_send)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendAddress, netty_unix_socket_sendAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recv, netty_unix_socket_recv)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recvAddress, netty_unix_socket_recvAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recvFd, netty_unix_socket_recvFd)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, sendFd, netty_unix_socket_sendFd)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, bindDomainSocket, netty_unix_socket_bindDomainSocket)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, connectDomainSocket, netty_unix_socket_connectDomainSocket)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setTcpNoDelay, netty_unix_socket_setTcpNoDelay)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setReusePort, netty_unix_socket_setReusePort)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setBroadcast, netty_unix_socket_setBroadcast)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setReuseAddress, netty_unix_socket_setReuseAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setReceiveBufferSize, netty_unix_socket_setReceiveBufferSize)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setSendBufferSize, netty_unix_socket_setSendBufferSize)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setKeepAlive, netty_unix_socket_setKeepAlive)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setSoLinger, netty_unix_socket_setSoLinger)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setTrafficClass, netty_unix_socket_setTrafficClass)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isKeepAlive, netty_unix_socket_isKeepAlive)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isTcpNoDelay, netty_unix_socket_isTcpNoDelay)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isBroadcast, netty_unix_socket_isBroadcast)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isReuseAddress, netty_unix_socket_isReuseAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isReusePort, netty_unix_socket_isReusePort)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getReceiveBufferSize, netty_unix_socket_getReceiveBufferSize)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getSendBufferSize, netty_unix_socket_getSendBufferSize)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getSoLinger, netty_unix_socket_getSoLinger)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getTrafficClass, netty_unix_socket_getTrafficClass)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getSoError, netty_unix_socket_getSoError)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isIPv6Preferred0, netty_unix_socket_isIPv6Preferred0)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, isIPv6, netty_unix_socket_isIPv6)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, msgFastopen, netty_unix_socket_msgFastopen)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setIntOpt, netty_unix_socket_setIntOpt)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setRawOptArray, netty_unix_socket_setRawOptArray)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, setRawOptAddress, netty_unix_socket_setRawOptAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getIntOpt, netty_unix_socket_getIntOpt)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getRawOptArray, netty_unix_socket_getRawOptArray)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, getRawOptAddress, netty_unix_socket_getRawOptAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recvFrom, netty_unix_socket_recvFrom)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recvFromAddress, netty_unix_socket_recvFromAddress)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recvFromDomainSocket, netty_unix_socket_recvFromDomainSocket)
NETTY_JNI_ALIAS(io_netty_channel_unix_Socket, recvFromAddressDomainSocket, netty_unix_socket_recvFromAddressDomainSocket)
