...
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, afInet,                              netty_quiche_afInet)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, afInet6,                             netty_quiche_afInet6)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofSockaddrIn,                    netty_quiche_sizeofSockaddrIn)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofSockaddrIn6,                   netty_quiche_sizeofSockaddrIn6)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrInOffsetofSinFamily,         netty_quiche_sockaddrInOffsetofSinFamily)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrInOffsetofSinPort,           netty_quiche_sockaddrInOffsetofSinPort)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrInOffsetofSinAddr,           netty_quiche_sockaddrInOffsetofSinAddr)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, inAddressOffsetofSAddr,              netty_quiche_inAddressOffsetofSAddr)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrIn6OffsetofSin6Family,       netty_quiche_sockaddrIn6OffsetofSin6Family)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrIn6OffsetofSin6Port,         netty_quiche_sockaddrIn6OffsetofSin6Port)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrIn6OffsetofSin6Flowinfo,     netty_quiche_sockaddrIn6OffsetofSin6Flowinfo)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrIn6OffsetofSin6Addr,         netty_quiche_sockaddrIn6OffsetofSin6Addr)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sockaddrIn6OffsetofSin6ScopeId,      netty_quiche_sockaddrIn6OffsetofSin6ScopeId)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, in6AddressOffsetofS6Addr,            netty_quiche_in6AddressOffsetofS6Addr)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofSockaddrStorage,               netty_quiche_sizeofSockaddrStorage)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofSizeT,                         netty_quiche_sizeofSizeT)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofSocklenT,                      netty_quiche_sizeofSocklenT)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheRecvInfoOffsetofFrom,          netty_quicheRecvInfoOffsetofFrom)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheRecvInfoOffsetofFromLen,       netty_quicheRecvInfoOffsetofFromLen)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheRecvInfoOffsetofTo,            netty_quicheRecvInfoOffsetofTo)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheRecvInfoOffsetofToLen,         netty_quicheRecvInfoOffsetofToLen)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofQuicheRecvInfo,                netty_sizeofQuicheRecvInfo)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheSendInfoOffsetofTo,            netty_quicheSendInfoOffsetofTo)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheSendInfoOffsetofToLen,         netty_quicheSendInfoOffsetofToLen)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheSendInfoOffsetofFrom,          netty_quicheSendInfoOffsetofFrom)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheSendInfoOffsetofFromLen,       netty_quicheSendInfoOffsetofFromLen)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quicheSendInfoOffsetofAt,            netty_quicheSendInfoOffsetofAt)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofQuicheSendInfo,                netty_sizeofQuicheSendInfo)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofTimespec,                      netty_quiche_sizeofTimespec)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofTimeT,                         netty_quiche_sizeofTimeT)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, sizeofLong,                          netty_quiche_sizeofLong)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, timespecOffsetofTvSec,               netty_quiche_timespecOffsetofTvSec)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, timespecOffsetofTvNsec,              timespecOffsetofTvNsec)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1protocol_1version,           netty_quiche_protocol_version)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1max_1conn_1id_1len,          netty_quiche_max_conn_id_len)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1shutdown_1read,              netty_quiche_shutdown_read)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1shutdown_1write,             netty_quiche_shutdown_write)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1done,                   netty_quiche_err_done)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1buffer_1too_1short,     netty_quiche_err_buffer_too_short)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1unknown_1version,       netty_quiche_err_unknown_version)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1invalid_1frame,         netty_quiche_err_invalid_frame)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1invalid_1packet,        netty_quiche_err_invalid_packet)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1invalid_1state,         netty_quiche_err_invalid_state)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1invalid_1stream_1state, netty_quiche_err_invalid_stream_state)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1invalid_1transport_1param, netty_quiche_err_invalid_transport_param)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1crypto_1fail,           netty_quiche_err_crypto_fail)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1tls_1fail,              netty_quiche_err_tls_fail)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1flow_1control,          netty_quiche_err_flow_control)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1stream_1limit,          netty_quiche_err_stream_limit)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1final_1size,            netty_quiche_err_final_size)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1stream_1stopped,        netty_quiche_err_stream_stopped)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1stream_1reset,          netty_quiche_err_stream_reset)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1congestion_1control,    netty_quiche_err_congestion_control)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1id_1limit,              netty_quiche_err_id_limit)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1out_1of_1identifiers,   netty_quiche_err_out_of_identifiers)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1key_1update,            netty_quiche_err_key_update)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1crypto_1buffer_1exceeded, netty_quiche_err_crypto_buffer_exceeded)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1err_1invalid_1dcid_1initialization, netty_quiche_err_invalid_dcid_initialization)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1cc_1reno,                    netty_quiche_cc_reno)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1cc_1cubic,                   netty_quiche_cc_cubic)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1cc_1bbr,                     netty_quiche_cc_bbr)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1path_1event_1new,            netty_quiche_path_event_type_new)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1path_1event_1validated,      netty_quiche_path_event_type_validated)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1path_1event_1failed_1validation, netty_quiche_path_event_type_failed_validation)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1path_1event_1closed,         netty_quiche_path_event_type_closed)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1path_1event_1reused_1source_1connection_1id, netty_quiche_path_event_type_reused_source_connection_id)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_QuicheNativeStaticallyReferencedJniMethods, quiche_1path_1event_1peer_1migrated, netty_quiche_path_event_type_peer_migrated)

NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1version,                            netty_quiche_version)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1version_1is_1supported,             netty_quiche_version_is_supported)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1negotiate_1version,                 netty_quiche_negotiate_version)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1retry,                              netty_quiche_retry)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1set_1qlog_1path,              netty_quiche_conn_set_qlog_path)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1send_1quantum,                netty_quiche_conn_send_quantum)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1trace_1id,                    netty_quiche_conn_trace_id)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1source_1id,                   netty_quiche_conn_source_id)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1destination_1id,              netty_quiche_conn_destination_id)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1new_1with_1tls,               netty_quiche_conn_new_with_tls)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1new_1with_1tls_1and_1client_1dcid, netty_quiche_conn_new_with_tls_and_client_dcid)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1recv,                         netty_quiche_conn_recv)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1send,                         netty_quiche_conn_send)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1free,                         netty_quiche_conn_free)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1peer_1error0,                 netty_quiche_conn_peer_error0)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1peer_1streams_1left_1bidi,    netty_quiche_conn_peer_streams_left_bidi)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1peer_1streams_1left_1uni,     netty_quiche_conn_peer_streams_left_uni)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stream_1priority,             netty_quiche_conn_stream_priority)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stream_1recv,                 netty_quiche_conn_stream_recv)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stream_1send,                 netty_quiche_conn_stream_send)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stream_1shutdown,             netty_quiche_conn_stream_shutdown)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stream_1capacity,             netty_quiche_conn_stream_capacity)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stream_1finished,             netty_quiche_conn_stream_finished)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1close,                        netty_quiche_conn_close)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1is_1established,              netty_quiche_conn_is_established)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1is_1in_1early_1data,          netty_quiche_conn_is_in_early_data)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1is_1closed,                   netty_quiche_conn_is_closed)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1is_1timed_1out,                netty_quiche_conn_is_timed_out)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1stats,                        netty_quiche_conn_stats)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1peer_1transport_1params,      netty_quiche_conn_peer_transport_params)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1timeout_1as_1nanos,           netty_quiche_conn_timeout_as_nanos)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1on_1timeout,                  netty_quiche_conn_on_timeout)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1readable,                     netty_quiche_conn_readable)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1writable,                     netty_quiche_conn_writable)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1stream_1iter_1free,                 netty_quiche_stream_iter_free)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1stream_1iter_1next,                 netty_quiche_stream_iter_next)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1dgram_1max_1writable_1len,    netty_quiche_conn_dgram_max_writable_len)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1dgram_1recv_1front_1len,      netty_quiche_conn_dgram_recv_front_len)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1dgram_1recv,                  netty_quiche_conn_dgram_recv)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1dgram_1send,                  netty_quiche_conn_dgram_send)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1set_1session,                 netty_quiche_conn_set_session)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1max_1send_1udp_1payload_1size, netty_quiche_conn_max_send_udp_payload_size)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1scids_1left,                  netty_quiche_conn_scids_left)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1new_1scid,                    netty_quiche_conn_new_scid)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1retired_1scid_1next,          netty_quiche_conn_retired_scid_next)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1new,                        netty_quiche_config_new)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1enable_1dgram,              netty_quiche_config_enable_dgram)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1grease,                     netty_quiche_config_grease)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1max_1idle_1timeout,    netty_quiche_config_set_max_idle_timeout)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1max_1recv_1udp_1payload_1size, netty_quiche_config_set_max_recv_udp_payload_size)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1max_1send_1udp_1payload_1size, netty_quiche_config_set_max_send_udp_payload_size)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1max_1data,    netty_quiche_config_set_initial_max_data)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1max_1stream_1data_1bidi_1local, netty_quiche_config_set_initial_max_stream_data_bidi_local)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1max_1stream_1data_1bidi_1remote, netty_quiche_config_set_initial_max_stream_data_bidi_remote)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1max_1stream_1data_1uni, netty_quiche_config_set_initial_max_stream_data_uni)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1max_1streams_1bidi, netty_quiche_config_set_initial_max_streams_bidi)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1max_1streams_1uni, netty_quiche_config_set_initial_max_streams_uni)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1ack_1delay_1exponent,  netty_quiche_config_set_ack_delay_exponent)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1max_1ack_1delay,       netty_quiche_config_set_max_ack_delay)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1disable_1active_1migration, netty_quiche_config_set_disable_active_migration)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1cc_1algorithm,         netty_quiche_config_set_cc_algorithm)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1initial_1congestion_1window_1packets, netty_quiche_config_set_initial_congestion_window_packets)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1enable_1hystart,            netty_quiche_config_enable_hystart)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1discover_1pmtu,             netty_quiche_config_discover_pmtu)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1active_1connection_1id_1limit, netty_quiche_config_set_active_connection_id_limit)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1set_1stateless_1reset_1token, netty_quiche_config_set_stateless_reset_token)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1config_1free,                       netty_quiche_config_free)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, buffer_1memory_1address,                    netty_buffer_memory_address)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, sockaddr_1cmp,                              netty_sockaddr_cmp)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1path_1event_1next,            netty_quiche_conn_path_event_next)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1type,                  netty_quiche_path_event_type)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1conn_1path_1stats,                  netty_quiche_conn_path_stats)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1new,                   netty_quiche_path_event_new)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1validated,             netty_quiche_path_event_validated)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1failed_1validation,    netty_quiche_path_event_failed_validation)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1closed,                netty_quiche_path_event_closed)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1reused_1source_1connection_1id, netty_quiche_path_event_reused_source_connection_id)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1peer_1migrated,        netty_quiche_path_event_peer_migrated)
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1path_1event_1free,                  netty_quiche_path_event_free)

// The dynamic method (quiche_enable_debug_logging) is registered with a
// package-prefix-aware signature at runtime; alias under the bare class name.
NETTY_JNI_ALIAS(io_netty_handler_codec_quic_Quiche, quiche_1enable_1debug_1logging,             netty_quiche_enable_debug_logging)
#endif
